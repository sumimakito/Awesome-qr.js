...
exports.QRUtil = exports.QRMaskPattern = exports.QRMode = exports.QRErrorCorrectLevel = exports.QRCodeModel = void 0;
var QRCodeModel = /** @class */ (function () {
    ...
    QRCodeModel.prototype._setupPositionAdjustPattern = function () {
    ...
    QRCodeModel.prototype._setupTypeNumber = function (test) {
    ...
    QRCodeModel.prototype._setupTypeInfo = function (test, maskPattern) {
...
var QR8bitByte = /** @class */ (function () {
    ...
    Object.defineProperty(QR8bitByte.prototype, "length", {
        get: function () {
...
})(QRMode = exports.QRMode || (exports.QRMode = {}));
var QRMaskPattern;
...
})(QRMaskPattern = exports.QRMaskPattern || (exports.QRMaskPattern = {}));
var QRUtil = /** @class */ (function () {
    function QRUtil() {
    }
    QRUtil.getUTF8Length = function (text) {
        var replacedText = encodeURI(text)
            .toString()
            .replace(/\%[0-9a-fA-F]{2}/g, "a");
        return replacedText.length + (replacedText.length != text.length ? 3 : 0);
    };
    QRUtil.getTypeNumber = function (text, nCorrectLevel) {
        var nType = 1;
        var length = QRUtil.getUTF8Length(text);
        for (var i = 0, len = QRUtil.LIMIT_LENGTH.length; i <= len; i++) {
            var nLimit = 0;
...
var QRPolynomial = /** @class */ (function () {
    ...
    Object.defineProperty(QRPolynomial.prototype, "length", {
        get: function () {
