...
var AwesomeQR = /** @class */ (function () {
    ...
    AwesomeQR.prototype._draw = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var nCount, rawSize, rawMargin, margin, rawViewportSize, whiteMargin, backgroundDimming, nSize, viewportSize, size, mainCanvas, mainCanvasContext, dotScale, backgroundCanvas, backgroundCanvasContext, parsedGIFBackground, gifFrames, gif, r, g, b, count, i, c, avgRGB, backgroundImage, agnPatternCenter, xyOffset, row, col, bIsDark, isBlkPosCtr, bProtected, i, nLeft, nTop, inAgnRange, protectorStyle, edgeCenter, i, j, agnX, agnY, i, i, j, agnX, agnY, logoScale, logoMargin, logoCornerRadius, logoImage, logoSize, x, y, gifOutput_1, backgroundCanvas_1, backgroundCanvasContext_1, patchCanvas_1, patchCanvasContext_1, patchData_1, outCanvas, outCanvasContext;
            return __generator(this, function (_b) {
                ...
                if (!!parsedGIFBackground) {
                    ...
                    gifOutput_1.finish();
                    console.log(gifOutput_1.stream());
