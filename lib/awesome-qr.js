            ...
            return __generator(this, function (_r) {
                switch (_r.label) {
                    ...
                    case 4:
                        ...
                        AwesomeQR._drawAlign(mainCanvasContext, cornerAlignmentCenter, cornerAlignmentCenter, nSize, cornerAlignmentXyOffset, cornerAlignmentScale, this.options.colorDark);
                        alignmentScale = ((_q = (_p = this.options.components) === null || _p === void 0 ? void 0 : _p.alignment) === null || _q === void 0 ? void 0 : _q.scale) || defaultScale;
                        ...
                        for (i = 0; i < alignmentPatternCenters.length; i++) {
                            for (j = 0; j < alignmentPatternCenters.length; j++) {
                                ...
                                if (agnX === 6 && (agnY === 6 || agnY === cornerAlignmentCenter)) {
                                    ...
                                    AwesomeQR._drawAlign(mainCanvasContext, agnX, agnY, nSize, alignmentXyOffset, alignmentScale, this.options.colorDark);
                                }
                            }
                        }
                        // Fill the margin
