...
const Drawing = (function () { // Drawing in Canvas
    ...
    Drawing.prototype.draw = function (oQRCode) {
        ...
        let _maskCanvas = undefined;
        let _mContext = undefined;
        ...
        for (let row = 0; row < nCount; row++) {
            for (let col = 0; col < nCount; col++) {
                ...
                for (i = 0; i < agnPatternCenter.length - 1; i++) {
                    bProtected = bProtected || (row >= agnPatternCenter[i] - 2 && row <= agnPatternCenter[i] + 2 &&
                        col >= agnPatternCenter[i] - 2 && col <= agnPatternCenter[i] + 2);
                }
